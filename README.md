...
<div>
  ...
  <p>
    WeakSet и WeakMap - это специальные структуры данных в JavaScript, которые могут использоваться для хранения "вспомогательных" данных, связанных с объектами, но при этом не предотвращают удаление этих     
    объектов из памяти, если на них больше нет ссылок.
  ...
  Итак, WeakSet и WeakMap полезны для хранения "слабых" связей между объектами, где дополнительные данные связаны с объектами, но не предотвращают удаление объектов, если на них больше нет активных ссылок.
